...
function RUOE_1_C1({ data, level, section, part, modelName, video, explanation }) {
  ...
  const renderText = () =>
    data.text.map((part, idx) => {
      ...
      // Incrementar contador para cada input
      inputCounter++;
  ...
  const renderExplanations = () => {
    ...
    // Convertir el objeto de explicaciones en un array
  ...
  return (
    <div className="max-w-7xl mx-auto p-7">
      ...
      {/* Grid de 2 columnas: izquierda ejercicio, derecha timer/tips/video */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Columna izquierda - Ejercicio (2/3 del ancho) */}
        ...
        {/* Columna derecha - ExerciseInfo (1/3 del ancho) */}
